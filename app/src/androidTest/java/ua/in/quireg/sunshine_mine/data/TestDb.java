...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        locationColumnHashSet.add(WeatherContract.LocationEntry.COLUMN_CITY_LAT);
        locationColumnHashSet.add(WeatherContract.LocationEntry.COLUMN_CITY_LON);
        locationColumnHashSet.add(WeatherContract.LocationEntry.COLUMN_LOC_COUNTRYCODE);
